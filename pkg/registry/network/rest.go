...
func (networkStrategy) Validate(ctx api.Context, obj runtime.Object) utilvalidation.ErrorList {
	network := obj.(*api.Network)
...
func (networkStrategy) ValidateUpdate(ctx api.Context, obj, old runtime.Object) utilvalidation.ErrorList {
...
func (networkStatusStrategy) ValidateUpdate(ctx api.Context, obj, old runtime.Object) utilvalidation.ErrorList {
